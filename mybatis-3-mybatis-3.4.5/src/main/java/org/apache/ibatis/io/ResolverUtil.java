 ...
 * </pre>
 *
 * @author Tim FennellI 工具类，根据指定条件查找指定包下的类
 */
public class ResolverUtil<T> {
	 ...
	 * presented for matching. 检测类是否继承了指定的类或接口
	 */
