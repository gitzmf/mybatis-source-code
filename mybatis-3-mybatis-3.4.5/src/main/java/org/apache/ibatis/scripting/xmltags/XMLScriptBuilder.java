...
public class XMLScriptBuilder extends BaseBuilder {
	...
	public SqlSource parseScriptNode() {
		//首先判断当前节点是不是动态sql,动态sql会包括占位符或是动态sql的相关节点
		List<SqlNode> contents = parseDynamicTags(context);
		//SqlNode集合中包装成一个MixedSqlNode
	...
	//如果selectKey节点下存在其他标签，则会调用nodeHandlers方法根据标签名称创建对应的NodeHandler对象
