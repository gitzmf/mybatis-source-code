 ...
 * @author Jeff Butler
 * 对于不支持自动生成自增主键的数据库，可以使用SelectKeyGenerator生成主键
 */
public class SelectKeyGenerator implements KeyGenerator {
	...
	//selectKey节点中定义的SQL语句所对应的MappedStatement对象，该对象是在
	//解析selectKey节点时创建
	...
	//会执行selectKey节点中配置的sql语句，获取insert语句中的主键并映射成对象
		...
		try {
			...
			if (parameter != null && keyStatement != null && keyStatement.getKeyProperties() != null) {
				...
				if (keyProperties != null) {
					...
					//创建Executor对象，并执行keyStatement字段记录的sql语句，得到主键对象
