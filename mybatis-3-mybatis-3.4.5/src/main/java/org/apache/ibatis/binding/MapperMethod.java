 ...
 * @author Lasse Voss 封装了Mapper接口中对应方法的信息
 */
public class MapperMethod {
	...
	public static class MethodSignature {
		...
		// 返回值类型为map的时候，该属性记录map的key列段
		private final String mapKey;
		// 用来标记该方法参数列表中resultHandler类型参数位置
		...
		// 方法的返回值是Map且指定了@MapKey注解，进新房getMapKey处理
