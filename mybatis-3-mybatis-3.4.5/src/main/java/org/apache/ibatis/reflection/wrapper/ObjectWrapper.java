...
/**
 * @author Clinton Begin MyBatis对对象级别元素信息的处理
 */
public interface ObjectWrapper {
	// 如果ObjectWrapper中封装的是普通Bean对象，则调用相应属性的相应的getter方法
	// 如果封装的是集合类，则获取指定key或下标对应的value值
	Object get(PropertyTokenizer prop);
	// 如果ObjectWrapper中封装的是普通Bean对象，则调用相应属性的相应的setter方法
	// 如果封装的是集合类，则获取指定key或下标对应的value值
