...
/**
 * @author Clinton Begin 每个resultmap节点都被解析成一个ResultMap对象，其中
 *         每个节点所定义的映射关系，则使用ResultMapping对象表示
 */
public class ResultMap {
	...
	//resultmap节点的type属性
	private Class<?> type;
	//记录了除了discriminator节点外的其他映射关系
	private List<ResultMapping> resultMappings;
	//记录了映射关系中带有id标志的映射关系
	private List<ResultMapping> idResultMappings;
	//记录了映射关系中带有 constructor标志的映射关系
	private List<ResultMapping> constructorResultMappings;
	//记录了映射关系中不带有 constructor标志的映射关系
	private List<ResultMapping> propertyResultMappings;
	//记录了所有映射关系中带有column属性的结合
	private Set<String> mappedColumns;
	private Set<String> mappedProperties;
	//鉴别器，对应discriminator节点
	private Discriminator discriminator;
	//是否含有嵌套查询，如果某个映射存在resultMap属性，且不存在resultSet属性，则为true
	private boolean hasNestedResultMaps;
	//是否含有嵌套查询，如果某个映射存在select属性，则为true
