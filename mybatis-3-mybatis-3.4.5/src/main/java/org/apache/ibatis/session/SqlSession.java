...
public interface SqlSession extends Closeable {
	 ...
	 * 泛型方法，参数表示的使用的查询SQL语句，返回值为查询的结果对象
	 */
	 ...
	 * 和selectList()方法类似，只是结果集会被映射成map对象返回。第二个参数指定了结果集的哪一列作为map的key
	 */
	 ...
	 * 查询的结果对象将由此处指定的ResultHandler对象处理，其余参数含义与selectList()类似
	 */
